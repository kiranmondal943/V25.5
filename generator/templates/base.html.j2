...
class SiteBuilder:
    ...
    def build_zip(self, context: dict, output_io: io.BytesIO):
        ...
        with zipfile.ZipFile(output_io, "w", zipfile.ZIP_DEFLATED) as zf:
            ...
            zf.writestr("sitemap.xml", f"<?xml version='1.0' encoding='UTF-8'?><urlset xmlns='http://www.sitemaps.org/schemas/sitemap/0.9'><url><loc>{ctx.get('prod_url','')}index.html</loc></url><url><loc>{ctx.get('prod_url','')}about.html</loc></url></urlset>")
